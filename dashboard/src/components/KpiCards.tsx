...
export function KpiCards({
  ...
  const pipelineCards = [
    ...
    ['Avg Detection Score', formatScore(feedbackSummary.averageRiskBeforeFeedback)],
    ['Avg Operational Priority', formatScore(feedbackSummary.averageRiskAfterFeedback)],
